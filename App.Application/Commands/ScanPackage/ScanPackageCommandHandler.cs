...
namespace NuReaper.Application.Commands.ScanPackage
{
    public class ScanPackageCommandHandler : IRequestHandler<ScanPackageCommand, ScanPackageResultResponse>
    {
        ...
        public ScanPackageCommandHandler(IAssemblyScanner scanner, IHostEnvironment env, INuspecParser nuspecParser, IDependencyRepository dependencyRepository, ILogger<ScanPackageCommandHandler> logger)
        {
            _scanner = scanner;
            _env = env;
            _logger = logger;
